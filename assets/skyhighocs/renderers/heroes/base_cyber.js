...
function render(entity, renderLayer, isFirstPersonArm) {
  ...
  if (entity.getData("skyhighocs:dyn/converted_cyber")) {
    ...
    if (entity.isWearingFullSuit()) {
      if (entity.getInterpolatedData("skyhighocs:dyn/thermoptic_camouflage_timer") < 1) {
        ...
        if (entity.getInterpolatedData("skyhighocs:dyn/thermoptic_disguise_timer") < 1) {
          ...
          left_leg_base_model.render();
          right_leg_base_model.render();
          if (!entity.getData("skyhighocs:dyn/cybernetic_body_lights") || entity.getInterpolatedData("skyhighocs:dyn/cybernetics_offline_timer") == 1) {
            head_lights_off_model.render();
            head_hair_lights_off_model.render();
            body_lights_off_model.render();
            left_arm_lights_off_model.render();
    ...
    if (entity.isWearingFullSuit() && isFirstPersonArm) {
      if (entity.getInterpolatedData("skyhighocs:dyn/cybernetic_interface_timer") > 0) {
        border.modelEffect.setScale(520.0*entity.getInterpolatedData("skyhighocs:dyn/cybernetic_interface_timer"), 260.0*entity.getInterpolatedData("skyhighocs:dyn/cybernetic_interface_timer"), 1.0);
        border.render(isFirstPersonArm);
        if (entity.getInterpolatedData("skyhighocs:dyn/cybernetic_interface_timer") == 1) {
              ...
              if (entity.getData("skyhighocs:dyn/satellite_deploy_timer") == 1) {
                ...
                if (cybernetics.isStillCyber(entity, id)) {
                  ...
                  if (sameFrequency && sameSatellite && sameUUID) {
                    ...
                    if (cyberEntity.getData(cyberDomain + ":dyn/cybernetics_offline_timer") > 0) {
                      text_renderer.renderLines(isFirstPersonArm, "left", "center", modelID + " (" + aliasName + ") is offline!", mainMenu.centerX, mainMenu.centerY, mainMenu.z + 0.08, 1.0);
                    } else {
                      if (cyberEntity.getData(cyberDomain + ":dyn/cybernetic_sleep_timer") == 1) {
                        text_renderer.renderLines(isFirstPersonArm, "left", "center", "Sleep Mode Active", mainMenu.centerX, mainMenu.centerY, mainMenu.z + 0.08, 1.0);
                      };
          ...
          if (entity.getData("skyhighocs:dyn/selected_button") == "main_settings" || entity.getData("skyhighocs:dyn/current_menu") == "settings") {
            ...
            if (entity.getData("skyhighocs:dyn/selected_button") == "settings_sleep") {
            ...
            if (entity.getData("skyhighocs:dyn/selected_button") == "settings_offline") {
      ...
      if (entity.getInterpolatedData("skyhighocs:dyn/cybernetic_interface_timer") == 0 && entity.getData("skyhighocs:dyn/tracked_waypoint") != "") {
      ...
      if (entity.getInterpolatedData("skyhighocs:dyn/cybernetic_interface_timer") == 0 && entity.getInterpolatedData("skyhighocs:dyn/charging_timer") == 1) {
      ...
      if (entity.getInterpolatedData("skyhighocs:dyn/cybernetic_interface_timer") == 0 && entity.getInterpolatedData("skyhighocs:dyn/cybernetic_sleep_timer") == 1) {
        text_renderer.renderLine(isFirstPersonArm, "center", "center", "Sleep Mode Active", 0.0, 0.0, -180.0, 2.0);
      };
      if (entity.getInterpolatedData("skyhighocs:dyn/cybernetic_interface_timer") == 0 && (entity.getInterpolatedData("skyhighocs:dyn/cybernetics_offline_timer") > 0) && (entity.getInterpolatedData("skyhighocs:dyn/cybernetics_offline_timer") < 1)) {
      ...
      if (entity.getInterpolatedData("skyhighocs:dyn/cybernetic_interface_timer") == 0 && entity.getInterpolatedData("skyhighocs:dyn/cybernetics_offline_timer") == 1) {
    ...
    if (entity.isWearingFullSuit() && !isFirstPersonArm) {
      if (entity.getInterpolatedData("skyhighocs:dyn/charging_timer") == 1) {
        var chargingLines = ["Charging...", (((entity.getInterpolatedData("skyhighocs:dyn/energy") / 1000000000) * 100).toFixed(0) + "%")];
        text_renderer.renderLines(isFirstPersonArm, "center", "center", chargingLines, 0.0, 6.0, -6.0, 0.5);
      };
      if (entity.getInterpolatedData("skyhighocs:dyn/cybernetic_sleep_timer") == 1) {
        text_renderer.renderLine(isFirstPersonArm, "center", "center", "Sleep Mode Active", 0.0, 6.0, -6.0, 0.5);
      };
      if ((entity.getInterpolatedData("skyhighocs:dyn/cybernetics_offline_timer") > 0) && (entity.getInterpolatedData("skyhighocs:dyn/cybernetics_offline_timer") < 1)) {
        if (entity.getData("skyhighocs:dyn/cybernetics_offline")) {
      ...
      if (entity.getInterpolatedData("skyhighocs:dyn/cybernetics_offline_timer") == 1) {
