...
loadTextures({
  ...
  "screen_color_4": "skyhighocs:transer/pegasus_color_4",
  "avatar_human": "skyhighocs:transer/aidan_stelar_head",
  "avatar_transformed": "skyhighocs:transer/squall_vortex_head",
  ...
  "visualizer_wave_change": "skyhighocs:aidan/aidan_stelar_visualizer_wave_change.tx.json",
...
function render(entity, renderLayer, isFirstPersonArm) {
  ...
  if (entity.is("DISPLAY")) {
    ...
    if (parent.hasEMBeing(entity) && (entity.as("DISPLAY").getDisplayType() == "HOLOGRAM" || entity.as("DISPLAY").getDisplayType() == "DISPLAY_STAND" || entity.as("DISPLAY").getDisplayType() == "ITERATOR_PREVIEW")) {
      maskWaveChangingLights.render();
      mask.render();
