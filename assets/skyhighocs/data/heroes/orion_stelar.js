...
var shocking = implement("skyhighocs:external/shocking");
var ecolyteSpark = implement("skyhighocs:external/ecolyte_spark");
var ecolyte = implement("skyhighocs:external/ecolyte");
...
function init(hero) {
  hero.setAliases("orion_stelar");
  hero.setName("Orion Stelar");
  hero.setTier(1);
