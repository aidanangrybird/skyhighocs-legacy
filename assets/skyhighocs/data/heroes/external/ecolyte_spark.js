...
function initModule(system) {
  ...
  return {
    ...
    powers: [
      ...
      "skyhighocs:battle_cards_orion"
    ],
    keyBinds: function (hero) {
      hero.addKeyBind("TELEPORT", "Transmit", 1);
      hero.addKeyBind("BATTLE_CARD_0", "Spark Buster!", 2);
      hero.addKeyBind("BATTLE_CARD_1", "Battle Card! Electrostatic Dome!", 2);
      hero.addKeyBind("BATTLE_CARD_2", "Battle Card! Taser!", 2);
      hero.addKeyBind("BATTLE_CARD_3", "Battle Card! Shock!", 2);
      hero.addKeyBind("BATTLE_CARD_4", "Battle Card! Arc!", 2);
      hero.addKeyBind("BATTLE_CARD_5", "Battle Card! Over Charge!", 2);
      hero.addKeyBind("INVISIBILITY", "Wave World", 3);
      hero.addKeyBind("CHARGE_ENERGY", "Arc", 4);
      hero.addKeyBind("CHARGED_BEAM", "Over Charge", 4);
    ...
    damageProfiles: function (entity) {
      var result = null;
      if (entity.getData("skyhighocs:dyn/taser_arc_timer") == 1 && entity.getData("skyhighocs:dyn/wave_changing_timer") == 1) {
        result = "SWORD";
      };
    ...
    attributeProfiles: function (entity) {
      ...
      if (entity.getData("skyhighocs:dyn/taser_arc_timer") == 1) {
        return "SWORD";
      };
      if (entity.getData("skyhighocs:dyn/taser_arc_timer") < 1 && !entity.getData("fiskheroes:shield_blocking")) {
        return null;
      };
    },
    isKeyBindEnabled: function (entity, keyBind) {
      ...
      if (keyBind == "CYCLE_CHATS_EM") {
        result = !entity.isSneaking() && entity.getData("skyhighocs:dyn/battle_card") == 0 && entity.getData("skyhighocs:dyn/ecolyte_timer") == 1;
      };
      ...
      if (keyBind == "TELEPORT" || keyBind == "INVISIBILITY") {
        result = !entity.getData("skyhighocs:dyn/transer");
      };
    ...
    isModifierEnabled: function (entity, modifier) {
      ...
      if (modifier.name() == "fiskheroes:shield") {
        if (modifier.id() == "electrostatic_dome") {
    ...
    tickHandler: function (entity, manager) {
      ...
      var taser = (entity.getData("skyhighocs:dyn/wave_changing_timer") == 1 && entity.getData("skyhighocs:dyn/battle_card") == 2 && (entity.getData("fiskheroes:flight_boost_timer") == 0 || (entity.getData("fiskheroes:flight_boost_timer") < 0.5 && !entity.isSprinting())));
      manager.setData(entity, "skyhighocs:dyn/taser", taser);
      var taser_arc = entity.getData("skyhighocs:dyn/taser_timer") == 1 && entity.getData("skyhighocs:dyn/item_holding_timer") == 0;
      manager.setData(entity, "skyhighocs:dyn/taser_arc", taser_arc);
      var shock = (entity.getData("skyhighocs:dyn/wave_changing_timer") == 1 && entity.getData("skyhighocs:dyn/battle_card") == 3 && (entity.getData("fiskheroes:flight_boost_timer") == 0 || (entity.getData("fiskheroes:flight_boost_timer") < 0.5 && !entity.isSprinting())));
      manager.setData(entity, "skyhighocs:dyn/shock", shock);
      var arc = (entity.getData("skyhighocs:dyn/wave_changing_timer") == 1 && entity.getData("skyhighocs:dyn/battle_card") == 4 && (entity.getData("fiskheroes:flight_boost_timer") == 0 || (entity.getData("fiskheroes:flight_boost_timer") < 0.5 && !entity.isSprinting())));
      manager.setData(entity, "skyhighocs:dyn/arc", arc);
      var over_charge = (entity.getData("skyhighocs:dyn/wave_changing_timer") == 1 && entity.getData("skyhighocs:dyn/battle_card") == 5 && (entity.getData("fiskheroes:flight_boost_timer") == 0 || (entity.getData("fiskheroes:flight_boost_timer") < 0.5 && !entity.isSprinting())));
      manager.setData(entity, "skyhighocs:dyn/over_charge", over_charge);
