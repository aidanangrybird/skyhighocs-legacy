  ...
  return {
    ...
    isKeyBindEnabled: function (entity, keyBind) {
      ...
      if (keyBind == "GRAVITY_MANIPULATION") {
        result = (entity.getData("skyhighocs:dyn/battle_card") > 0 || entity.getData("skyhighocs:dyn/solar_timer") < 1) && entity.getData("skyhighocs:dyn/wave_changing_timer") == 1;
      };
      ...
      if (keyBind == "AIM") {
        result = ((entity.getHeldItem().isEmpty() && entity.getData("skyhighocs:dyn/battle_card") == 0 && entity.getData("skyhighocs:dyn/solar_timer") < 1) || entity.getHeldItem().name() == "fiskheroes:chronos_rifle") && entity.getData("skyhighocs:dyn/wave_changing_timer") == 1;
      };
