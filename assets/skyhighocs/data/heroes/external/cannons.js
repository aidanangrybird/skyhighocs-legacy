...
function initModule(system) {
  ...
  var cannonMultiTap = system.initMultiTap("skyhighocs:dyn/cannon");
  return {
    name: "cannons",
    ...
    isModifierEnabled: function (entity, modifier) {
      result = false;
      if (!system.isModuleDisabled(entity, this.name)) {
        var head = (entity.getData("skyhighocs:dyn/cannons_head_armed")) ? "T" : "F";
        var body = (entity.getData("skyhighocs:dyn/cannons_body_armed")) ? "T" : "F";
        var arms = (entity.getData("skyhighocs:dyn/cannons_arms_armed")) ? "T" : "F";
        if (modifier.name() == "fiskheroes:charged_beam" && !entity.getData("skyhighocs:dyn/battle_mode")) {
      ...
      if (argList.length > 1 && argList.length < 5) {
        ...
        switch (argList[1]) {
          ...
          case "show":
            switch (argList[2]) {
              case "head":
                manager.setData(entity, "skyhighocs:dyn/cannon_head_left_deployed", true);
                manager.setData(entity, "skyhighocs:dyn/cannon_head_right_deployed", true);
          ...
          case "hide":
            switch (argList[2]) {
              case "head":
                manager.setData(entity, "skyhighocs:dyn/cannon_head_left_deployed", false);
                manager.setData(entity, "skyhighocs:dyn/cannon_head_right_deployed", false);
          ...
          case "set":
            switch (argList[2]) {
              case "holo":
                ...
                break;
              case "flushHead":
                manager.setData(entity, "skyhighocs:dyn/cannon_head_flush_enabled", ((argList[3] == "true") ? true : (argList[3] == "false") ? false : entity.getData("skyhighocs:dyn/cannon_head_flush_enabled")));
                ...
                break;
              case "flushBody":
                manager.setData(entity, "skyhighocs:dyn/cannon_body_flush_enabled", ((argList[3] == "true") ? true : (argList[3] == "false") ? false : entity.getData("skyhighocs:dyn/cannon_body_flush_enabled")));
                ...
                break;
              case "flushLeftArm":
                manager.setData(entity, "skyhighocs:dyn/cannon_left_arm_flush_enabled", ((argList[3] == "true") ? true : (argList[3] == "false") ? false : entity.getData("skyhighocs:dyn/cannon_left_arm_flush_enabled")));
                ...
                break;
              case "flushRightArm":
                manager.setData(entity, "skyhighocs:dyn/cannon_right_arm_flush_enabled", ((argList[3] == "true") ? true : (argList[3] == "false") ? false : entity.getData("skyhighocs:dyn/cannon_right_arm_flush_enabled")));
          ...
          case "status":
            ...
            system.moduleMessage(this, entity, "<n>Head set: <nh>" + (entity.getData("skyhighocs:dyn/cannons_head_armed") ? "ARMED" : "DISARMED"));
            system.moduleMessage(this, entity, "<n>Body set: <nh>" + (entity.getData("skyhighocs:dyn/cannons_body_armed") ? "ARMED" : "DISARMED"));
            system.moduleMessage(this, entity, "<n>Arm set: <nh>" + (entity.getData("skyhighocs:dyn/cannons_arms_armed") ? "ARMED" : "DISARMED"));
            system.moduleMessage(this, entity, "<n>Left Head: <nh>" + ((entity.getData("skyhighocs:dyn/cannon_head_left_deploy_timer") > 0) || headSet ? "DEPLOYED" : "STOWED"));
            system.moduleMessage(this, entity, "<n>Right Head: <nh>" + ((entity.getData("skyhighocs:dyn/cannon_head_right_deploy_timer") > 0) || headSet ? "DEPLOYED" : "STOWED"));
            system.moduleMessage(this, entity, "<n>Left Body: <nh>" + ((entity.getData("skyhighocs:dyn/cannon_body_left_deploy_timer") > 0) || bodySet ? "DEPLOYED" : "STOWED"));
            system.moduleMessage(this, entity, "<n>Right Body: <nh>" + ((entity.getData("skyhighocs:dyn/cannon_body_right_deploy_timer") > 0) || bodySet ? "DEPLOYED" : "STOWED"));
            system.moduleMessage(this, entity, "<n>Left Arm bottom: <nh>" + ((entity.getData("skyhighocs:dyn/cannon_left_arm_bottom_deploy_timer") > 0) || armSet ? "DEPLOYED" : "STOWED"));
            system.moduleMessage(this, entity, "<n>Left Arm front: <nh>" + ((entity.getData("skyhighocs:dyn/cannon_left_arm_front_deploy_timer") > 0) || armSet ? "DEPLOYED" : "STOWED"));
            system.moduleMessage(this, entity, "<n>Left Arm back: <nh>" + ((entity.getData("skyhighocs:dyn/cannon_left_arm_back_deploy_timer") > 0) || armSet ? "DEPLOYED" : "STOWED"));
            system.moduleMessage(this, entity, "<n>Right Arm bottom: <nh>" + ((entity.getData("skyhighocs:dyn/cannon_right_arm_bottom_deploy_timer") > 0) || armSet ? "DEPLOYED" : "STOWED"));
            system.moduleMessage(this, entity, "<n>Right Arm front: <nh>" + ((entity.getData("skyhighocs:dyn/cannon_right_arm_front_deploy_timer") > 0) || armSet ? "DEPLOYED" : "STOWED"));
            system.moduleMessage(this, entity, "<n>Right Arm back: <nh>" + ((entity.getData("skyhighocs:dyn/cannon_right_arm_back_deploy_timer") > 0) || armSet ? "DEPLOYED" : "STOWED"));
            system.moduleMessage(this, entity, "<n>Flush Head Cannons: <nh>" + (entity.getData("skyhighocs:dyn/cannon_head_flush_enabled") ? "ENABLED" : "DISABLED"));
            system.moduleMessage(this, entity, "<n>Flush Body Cannons: <nh>" + (entity.getData("skyhighocs:dyn/cannon_body_flush_enabled") ? "ENABLED" : "DISABLED"));
            system.moduleMessage(this, entity, "<n>Flush Left Arm Cannon: <nh>" + (entity.getData("skyhighocs:dyn/cannon_left_arm_flush_enabled") ? "ENABLED" : "DISABLED"));
            system.moduleMessage(this, entity, "<n>Flush Right Arm Cannon: <nh>" + (entity.getData("skyhighocs:dyn/cannon_right_arm_flush_enabled") ? "ENABLED" : "DISABLED"));
    ...
    tickHandler: function (entity, manager) {
      ...
      if ((!entity.getData("skyhighocs:dyn/cannons_head_armed") || !entity.getData("skyhighocs:dyn/cannons_body_armed") || !entity.getData("skyhighocs:dyn/cannons_arms_armed")) && cannonMultiTap.multiTap(entity, manager, 2, 20, 1)) {
        manager.setData(entity, "skyhighocs:dyn/cannons_head_armed", true);
        manager.setData(entity, "skyhighocs:dyn/cannons_body_armed", true);
        manager.setData(entity, "skyhighocs:dyn/cannons_arms_armed", true);
        manager.setBoolean(nbt, "cannonsHead", true);
      ...
      if ((entity.getData("skyhighocs:dyn/cannons_head_armed") || entity.getData("skyhighocs:dyn/cannons_body_armed") || entity.getData("skyhighocs:dyn/cannons_arms_armed")) && entity.getData("fiskheroes:beam_charge") > 0) {
      ...
      manager.setData(entity, "skyhighocs:dyn/cannon_head_flush", entity.getData("skyhighocs:dyn/cannon_head_flush_enabled"));
      manager.setData(entity, "skyhighocs:dyn/cannon_body_flush", entity.getData("skyhighocs:dyn/cannon_body_flush_enabled"));
      manager.setData(entity, "skyhighocs:dyn/cannon_left_arm_flush", entity.getData("skyhighocs:dyn/cannon_left_arm_flush_enabled"));
      manager.setData(entity, "skyhighocs:dyn/cannon_right_arm_flush", entity.getData("skyhighocs:dyn/cannon_right_arm_flush_enabled"));
    ...
    onInitSystem: function (entity, manager) {
      ...
      manager.setData(entity, "skyhighocs:dyn/cannons_head_armed", nbt.getBoolean("cannonsHead"));
      if (!nbt.hasKey("cannonsBody")) {
        manager.setBoolean(nbt, "cannonsBody", false);
      };
      manager.setData(entity, "skyhighocs:dyn/cannons_body_armed", nbt.getBoolean("cannonsBody"));
      if (!nbt.hasKey("cannonsArms")) {
        manager.setBoolean(nbt, "cannonsArms", false);
      };
      manager.setData(entity, "skyhighocs:dyn/cannons_arms_armed", nbt.getBoolean("cannonsArms"));
